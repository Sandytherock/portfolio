      ...
      <Container>
        <div className="flex items-center justify-between h-16">
          ...
          <button
            ...
            className="text-xl font-bold text-slate-900 dark:text-slate-100 hover:text-primary-600 dark:hover:text-primary-400 transition-colors focus-ring rounded-lg px-2 py-1"
          >
            {profile.name}
          </button>
        ...
        {/* Mobile Navigation */}
        <div className="lg:hidden pb-4 overflow-x-auto custom-scrollbar">
